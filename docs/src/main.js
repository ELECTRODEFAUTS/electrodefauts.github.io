    ...
    populateCSVSelector: function(files, options = {}) {
        ...
        const renderRows = () => {
            ...
            filtered.forEach(item => {
                ...
                card.className = 'bg-white border-b-4 border-indigo-500 rounded-xl p-3 cursor-pointer hover:scale-105 hover:shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:border-indigo-600 transition-all flex flex-col justify-between group relative text-slate-900';
